...
--Pick an order and get all information about that order included in the order form.
...
-- Information about the items included in an order
...
--What is the phone number of the salesrep who took order in the query above?
...
--Pick a driver and list all customers whose orders have been delivered by him/her.
...
--What is the total value (quantity time unit price) of all items in stock that have unit prices exceeding $25?
